...
public class RegisterForm {
    ...
    public RegisterForm() {
        ...
        // LOGIKA ZA DUGME REGISTRUJ SE
        btnRegister.addActionListener(e -> {
            String ime = txtImePrezime.getText();
            String user = txtUsername.getText();
            String pass = new String(txtPassword.getPassword());
            String tema = "Standard";
            // USLOV 6: Validacija lozinke (više od 4 karaktera + barem 1 broj)
            ...
            try {
                ...
                // USLOV 4: Čuvanje svih podataka (ime, user, pass, tema)
                Document newUser = new Document("username", user)
                        .append("password", pass) // U realnom sistemu bi ovdje išao hash, ali za projekat je OK ovako
                ...
                frame.dispose(); // Zatvori registraciju
                new LoginForm(); // Vrati se na login
...
// LOGIKA ZA DUGME NAZAD NA LOGIN
        btnBackToLogin.addActionListener(e -> {
            frame.dispose(); // Zatvara trenutni prozor (Register)
            new LoginForm(); // Otvara Login prozor
        });
    ...
    // USLOV 6: Pomoćna metoda za provjeru lozinke
    private boolean isValidPassword(String password) {
        // Provjera dužine (> 4 znači minimalno 5)
        if (password.length() <= 4) return false;

        // Provjera da li sadrži barem jedan broj (regex .*\\d.* znači "bilo šta, pa broj, pa bilo šta")
